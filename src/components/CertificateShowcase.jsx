      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-4xl mx-auto bg-slate-950 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl relative">
          ...
          <div className="grid grid-cols-12 gap-3 sm:gap-8 items-center">
            ...
            {/* Left Image View */}
            <div className="col-span-6 md:col-span-7 relative rounded-xl sm:rounded-2xl overflow-hidden border border-slate-800 bg-slate-950 aspect-[4/3] flex items-center justify-center p-1 sm:p-2 group shadow-inner">
              <ProtectedImage
                src={cert.imageUrl}
                alt={congratsHeading}
